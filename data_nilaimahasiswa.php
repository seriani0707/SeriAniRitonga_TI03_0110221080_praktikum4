...
<html lang="en">
  <head>
    ...
    <title>Nilai Mahasiswa - Seri Ani Ritonga</title>
  </head>
  <body>
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <select id="matakuliah" name="matakuliah" class="custom-select">
        <option value="Basis Data">Pemograman Web</option>
        <option value="Basis Data">Basis Data</option>
        <option value="Statistika & Rpobalitas">Statistika & Rpobalitas</option>
      </select>
    </div>
  </div>
  <div class="form-group row">
    ...
    <input type="submit" name="proses" value="Simpan" class="bg-success text-white rounded border-0 p-2">
	  ...
	  <div class="row">
        ...
        <?php
            ...
            echo '<br>NIM : '.$nm1->nim;
            echo '<br>Mata Kuiah : '.$nm1->matakuliah;
